...
if __name__ == "__main__":
    ...
    print(f"The schedule of MIRI coronagraphic observations has been updated and is available here: https://innerspace.stsci.edu/display/JWST/MIRI+Coronagraphy+Scheduling+Table")
